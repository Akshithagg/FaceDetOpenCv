...
faces=face_cascade.detectMultiScale(
    gray,
    scaleFactor=1.1, #image being resized or shrinked to detect faces of different sizes (.1 =10%)
    minNeighbors=5, #how many times a face must be detected before confirming its a face 
    minSize=(30,30) ,
    #  min pixels size the picture should be able to detect face
    maxSize=(300,300),
)
